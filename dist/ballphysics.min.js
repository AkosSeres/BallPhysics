        ...
        function r(e, n, t) {
                ...
                _createClass(Physics, [{
                    ...
                    value: function update(t, precise) {
                        ...
                        for (var _i5 = 0; _i5 < this.balls.length; _i5++) {
                            ...
                            try {
                                for (var _iterator6 = this.fixedBalls[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                    ...
                                    fixedBallCollision: if (heading === 0 || heading) {
                                        ...
                                        var deltaAng = Math.sign(vel.x - ball.ang * ball.r) * (dvy * ball.fc) / (ball.amc * ball.r);
                                        var maxDeltaAng = (vel.x - ball.ang * ball.r) / ball.r;
                                        if (deltaAng / maxDeltaAng > 1) deltaAng = maxDeltaAng;
                                        deltaAng *= ball.amc / (ball.amc + 1);
                                        ball.ang += deltaAng;
                                        var dvx = deltaAng * ball.r;
                                        vel.x -= dvx;
                                        pos.rotate(heading - Math.PI / 2);
                                        vel.rotate(heading - Math.PI / 2);
                                        ball.pos.x = pos.x;
                            ...
                            try {
                                for (var _iterator7 = this.bounds[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                                    var bound = _step7.value;

                                    bound.collideWithBall(this.balls[_i5]);
                                }
                            } catch (err) {
                        ...
                        for (var _i6 = 0; _i6 < this.bodies.length; _i6++) {
                            ...
                            try {
                                for (var _iterator8 = this.balls[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                                    var _ball = _step8.value;

                                    if (_ball.layer != this.bodies[_i6].layer || !_ball.layer && !this.bodies[_i6].layer) {
                                        this.bodies[_i6].collideWithBall(_ball);
                                    }
                                }
                            } catch (err) {
                        ...
                        for (var _i7 = 0; _i7 < 3; _i7++) {
                            ...
                            try {
                                for (var _iterator9 = this.springs[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    ...
                    key: "addSoftSquare",
                    value: function addSoftSquare(pos, sideSize, fc, vel) {
                        var _balls2, _springs2;

                        var softSquare = new softball_1.default(pos, Math.sqrt(sideSize * sideSize / Math.PI), 1, fc, 24);
                        softSquare.sides.forEach(function (side) {
                            side.length = 0.96 * 4 * sideSize / softSquare.resolution;
                        });
                        softSquare.points.forEach(function (b) {
                            b.vel = vel.copy;
                        });
                        (_balls2 = this.balls).push.apply(_balls2, _toConsumableArray(softSquare.points));
                        (_springs2 = this.springs).push.apply(_springs2, _toConsumableArray(softSquare.sides));
                        var springStrength = sideSize * sideSize * 200;
                        var bigStick = new spring_1.default(Math.sqrt(softSquare.r * softSquare.r * Math.PI), springStrength / 2);
                    ...
                    value: function setBounds(x, y, w, h) {
                        this.bounds = [];
                        var getRectBody = function getRectBody(x_, y_, w_, h_) {
                            var points = [];
            ...
            var SoftBall = function () {
                ...
                function SoftBall(pos, r, pressure, fc, resolution) {
                    ...
                    r = Math.abs(r);
                    this.r = r;
                    var layerNumber = Math.random() * 1000000;
