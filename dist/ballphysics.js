                ...
                _createClass(Physics, [{
                    ...
                    value: function update(t) {
                        ...
                        for (var _i4 = 0; _i4 < this.springs.length; _i4++) {
                            ...
                            try {
                                for (var _iterator = this.springs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        for (var _i5 = 0; _i5 < this.balls.length; _i5++) {
                            ...
                            try {
                                for (var _iterator2 = this.walls[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            try {
                                for (var _iterator3 = this.fixedBalls[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                                    var b = _step3.value;
                        ...
                        for (var _i7 = 0; _i7 < this.springs.length; _i7++) {
                            ...
                            try {
                                for (var _iterator5 = this.springs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
