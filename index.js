...
`;var $n=class extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Qn.content.cloneNode(!0)),this.shadowRoot.appendChild(l("div",{id:"btn"},l("slot",null))),this.hidden=!1}set bgColor(e){this.btn.style.backgroundColor=e}set textColor(e){this.btn.style.color=e}get btn(){return this.shadowRoot.getElementById("btn")}set onClick(e){this.btn.onclick=e}set onEnter(e){this.btn.onpointerenter=e}set onLeave(e){this.btn.onpointerleave=e}hide(){this.btn.classList.add("hidden"),this.hidden=!0}show(){this.btn.classList.remove("hidden"),this.hidden=!1}asUpper(){this.btn.classList.add("upper")}asMiddle(){this.btn.classList.remove("upper"),this.btn.classList.remove("last")}asLast(){this.btn.classList.add("last")}};window.customElements.define("hover-detector-btn",$n);var Kn=document.createElement("template");Kn.innerHTML=`
  <style>
    .number-label {
        display: flex;
        align-items: center;
...
`;var Zn=class extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Kn.content.cloneNode(!0)),this.customHeightDiv=l("div",null),this.customHeightDiv.style.height="1rem",this.shadowRoot.appendChild(this.customHeightDiv)}set height(e){this.customHeightDiv.style.height=`${e}rem`}};window.customElements.define("space-height",Zn);var _n=document.createElement("template");_n.innerHTML=`
  <style>
    .slider {
...
`;var An=class extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(_n.content.cloneNode(!0)),this.shadowRoot.appendChild(l("div",null,l("p",{className:"slider-label"},l("slot",null)),l("input",{id:"slider",type:"range",className:"slider"})))}get slider(){return this.shadowRoot.querySelector("#slider")}set min(e){this.slider.min=e}set max(e){this.slider.max=e}set step(e){this.slider.step=e}set value(e){this.slider.value=e}set onChange(e){this.slider.onchange=t=>e(t.target.valueAsNumber),this.slider.oninput=t=>e(t.target.valueAsNumber)}};window.customElements.define("range-slider",An);var es=document.createElement("template");es.innerHTML=`
  <style>
    .picker-label {
        display: flex;
        align-items: center;
...
`;var ts=class extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(es.content.cloneNode(!0)),this.shadowRoot.appendChild(l("div",null,l("label",{htmlFor:"colorWell",className:"picker-label"},l("div",null,l("slot",null)),l("input",{type:"color",id:"colorWell"}))))}get picker(){return this.shadowRoot.querySelector("#colorWell")}set value(e){this.picker.value=e,this.picker.style["background-color"]=e}set onChange(e){let t=s=>{e(s.target.value),this.picker.style["background-color"]=s.target.value};this.picker.onchange=t,this.picker.oninput=t}};window.customElements.define("color-picker",ts);var He=35,wt=.5,kt=1.5,Mt=Bn,ns=document.createElement("div"),Yo={name:"Ball",description:"",element:ns,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black",n.mouseDown?(t.beginPath(),t.arc(n.lastX,n.lastY,He,0,2*Math.PI),t.stroke()):(t.beginPath(),t.arc(n.mouseX,n.mouseY,He,0,2*Math.PI),t.stroke()),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=new y(P.Circle(He,new i(n.lastX,n.lastY)),1,wt,kt);e.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),e.style=Mt,Number.isFinite(e.pos.x)&&Number.isFinite(e.pos.y)&&Number.isFinite(e.vel.x)&&Number.isFinite(e.vel.y)||(e.vel.x=0,e.vel.y=0),n.physics.addBody(e)}}};ns.append(l("range-slider",{min:5,max:120,step:1,value:He,onChange:n=>{He=n}},"Size"),l("range-slider",{min:0,max:1,step:.02,value:wt,onChange:n=>{wt=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:kt,onChange:n=>{kt=n}},"Coefficient of friction"),l("color-picker",{value:Mt,onChange:n=>{Mt=n}},"Color:"));var ss=Yo;var Lo=document.createElement("div"),Do={name:"Rectangle wall",description:"",element:Lo,drawFunc(n,e){if(n.lastX!==0&&n.lastY!==0){let t=n.cnv.getContext("2d"),s=Math.abs(n.mouseX-n.lastX),o=Math.abs(n.mouseY-n.lastY);s/o>50||o/s>50||o<15||s<15?t.strokeStyle="red":t.strokeStyle="black",t.strokeRect(n.mouseX,n.mouseY,n.lastX-n.mouseX,n.lastY-n.mouseY)}},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=Math.abs(n.mouseX-n.lastX),t=Math.abs(n.mouseY-n.lastY);if(e/t>50||t/e>50||t<15||e<15)return;n.physics.addRectWall(n.lastX/2+n.mouseX/2,n.lastY/2+n.mouseY/2,2*Math.abs(n.lastX/2-n.mouseX/2),2*Math.abs(n.lastY/2-n.mouseY/2));let s=n;s.physics.bodies[s.physics.bodies.length-1].style=w.Beige}}},os=Do;var St=.2,Pt=.5,It=R,is=document.createElement("div"),zo={name:"Rectangle body",description:"",element:is,drawFunc(n,e){let t=n.cnv.getContext("2d");if(n.mouseDown){let s=Math.abs(n.mouseX-n.lastX),o=Math.abs(n.mouseY-n.lastY);s/o>50||o/s>50||o<13||s<13?t.strokeStyle="red":t.strokeStyle="black",t.strokeRect(n.mouseX,n.mouseY,n.lastX-n.mouseX,n.lastY-n.mouseY)}},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=Math.abs(n.mouseX-n.lastX),t=Math.abs(n.mouseY-n.lastY);if(e/t>50||t/e>50||t<13||e<13)return;n.physics.addRectBody(n.lastX/2+n.mouseX/2,n.lastY/2+n.mouseY/2,2*Math.abs(n.lastX/2-n.mouseX/2),2*Math.abs(n.lastY/2-n.mouseY/2),Pt,St,It)}},keyGotUpFunc(n){},keyGotDownFunc(n){}};is.append(l("range-slider",{min:0,max:.6,step:.02,value:St,onChange:n=>{St=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:Pt,onChange:n=>{Pt=n}},"Coefficient of friction"),l("color-picker",{value:It,onChange:n=>{It=n}},"Color:"));var as=zo;var st=35,Ct=.5,Et=.5,ot=4,it=24,Bt=R,rs=document.createElement("div");function cs(n=24,e=4){return[...new Array(n).keys()].map(t=>i.fromAnglePNorm(Math.PI*2*t/n,e))}var No={name:"Squircle",description:"",element:rs,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=cs(it,ot);if(s.forEach(o=>o.mult(st)),n.mouseDown){t.beginPath(),t.moveTo(n.lastX+s[0].x,n.lastY+s[0].y);for(let o=1;o<s.length;o+=1)t.lineTo(n.lastX+s[o].x,n.lastY+s[o].y);t.closePath(),t.stroke()}else{t.beginPath(),t.moveTo(n.mouseX+s[0].x,n.mouseY+s[0].y);for(let o=1;o<s.length;o+=1)t.lineTo(n.mouseX+s[o].x,n.mouseY+s[o].y);t.closePath(),t.stroke()}n.mouseDown&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){let e=cs(it,ot),t=new i(n.lastX,n.lastY);if(e.forEach(s=>{s.mult(st),s.add(t)}),n.lastX!==0&&n.lastY!==0){let s=new y(P.Polygon(e),1,Ct,Et);s.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),s.style=Bt,n.physics.addBody(s)}}};rs.append(l("range-slider",{min:5,max:120,step:1,value:st,onChange:n=>{st=n}},"Size"),l("range-slider",{min:2,max:7,step:1,value:9-ot,onChange:n=>{ot=9-n}},"Roundness"),l("range-slider",{min:12,max:36,step:1,value:it,onChange:n=>{it=n}},"Resolution"),l("range-slider",{min:0,max:.9,step:.02,value:Ct,onChange:n=>{Ct=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:Et,onChange:n=>{Et=n}},"Coefficient of friction"),l("color-picker",{value:Bt,onChange:n=>{Bt=n}},"Color:"));var ls=No;var K=35;var Tt=1.5,Rt=24,Ft=1,hs=document.createElement("div"),jo={name:"Soft square",description:"",element:hs,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black",n.mouseDown?t.strokeRect(n.lastX-K,n.lastY-K,K*2,K*2):t.strokeRect(n.mouseX-K,n.mouseY-K,K*2,K*2),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){n.lastX!==0&&n.lastY!==0&&n.physics.addSoftSquare(new i(n.lastX,n.lastY),K*2,Tt,new i(n.lastX-n.mouseX,n.lastY-n.mouseY),Rt,Ft)}};hs.append(l("range-slider",{min:5,max:100,step:1,value:K,onChange:n=>{K=n}},"Size"),l("range-slider",{min:.4,max:3,step:.1,value:Ft,onChange:n=>{Ft=n}},"Pressure"),l("range-slider",{min:0,max:2,step:.1,value:Tt,onChange:n=>{Tt=n}},"Coefficient of friction"),l("range-slider",{min:16,max:48,step:8,value:Rt,onChange:n=>{Rt=n}},"Resolution"));var ds=jo;var at=20,ms=document.createElement("div"),Ho={name:"Wall drawer",description:"",element:ms,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black",t.beginPath(),t.arc(n.mouseX,n.mouseY,at,0,2*Math.PI),t.stroke(),n.lastX!==0&&n.lastY!==0&&n.physics.addFixedBall(n.mouseX,n.mouseY,at)}};ms.append(l("range-slider",{min:5,max:70,step:1,value:at,onChange:n=>{at=n}},"Size"));var us=Ho;var Ot=45,Xt=.2,Yt=1.5,Lt=R,fs=document.createElement("div");function Dt(n){let e=n;return n===void 0&&(e=new i(0,0)),P.Polygon([...new Array(3).keys()].map(t=>{let s=2*Math.PI*t/3,o=i.fromAngle(s);return o.rotate(-(Math.PI*7)/6),o.mult(Ot),o.add(e),o}))}var Vo={name:"Triangle",description:"",element:fs,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=new i(n.mouseX,n.mouseY);n.mouseDown?(s.x=n.lastX,s.y=n.lastY,t.beginPath(),Dt(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()):(t.beginPath(),Dt(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=new i(n.lastX,n.lastY),t=new y(Dt(e),1,Xt,Yt);t.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),t.style=Lt,Number.isFinite(t.pos.x)&&Number.isFinite(t.pos.y)&&Number.isFinite(t.vel.x)&&Number.isFinite(t.vel.y)||(t.vel.x=0,t.vel.y=0),n.physics.addBody(t)}}};fs.append(l("range-slider",{min:5,max:120,step:1,value:Ot,onChange:n=>{Ot=n}},"Size"),l("range-slider",{min:0,max:.35,step:.02,value:Xt,onChange:n=>{Xt=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:Yt,onChange:n=>{Yt=n}},"Coefficient of friction"),l("color-picker",{value:Lt,onChange:n=>{Lt=n}},"Color:"));var ps=Vo;var zt=45,Nt=.2,jt=1.5,Ht=R,gs=document.createElement("div");function Vt(n){let e=n;return n===void 0&&(e=new i(0,0)),P.Polygon([...new Array(5).keys()].map(t=>{let s=2*Math.PI*t/5,o=i.fromAngle(s);return o.rotate(-Math.PI/10),o.mult(zt),o.add(e),o}))}var qo={name:"Pentagon",description:"",element:gs,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=new i(n.mouseX,n.mouseY);n.mouseDown?(s.x=n.lastX,s.y=n.lastY,t.beginPath(),Vt(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()):(t.beginPath(),Vt(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=new i(n.lastX,n.lastY),t=new y(Vt(e),1,Nt,jt);t.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),t.style=Ht,Number.isFinite(t.pos.x)&&Number.isFinite(t.pos.y)&&Number.isFinite(t.vel.x)&&Number.isFinite(t.vel.y)||(t.vel.x=0,t.vel.y=0),n.physics.addBody(t)}}};gs.append(l("range-slider",{min:5,max:120,step:1,value:zt,onChange:n=>{zt=n}},"Size"),l("range-slider",{min:0,max:1,step:.02,value:Nt,onChange:n=>{Nt=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:jt,onChange:n=>{jt=n}},"Coefficient of friction"),l("color-picker",{value:Ht,onChange:n=>{Ht=n}},"Color:"));var bs=qo;var qt=45,Wt=.2,Ut=1.5,Gt=R,ys=document.createElement("div");function Jt(n){let e=n;return n===void 0&&(e=new i(0,0)),P.Polygon([...new Array(6).keys()].map(t=>{let s=2*Math.PI*t/6,o=i.fromAngle(s);return o.mult(qt),o.add(e),o}))}var Wo={name:"Hexagon",description:"",element:ys,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=new i(n.mouseX,n.mouseY);n.mouseDown?(s.x=n.lastX,s.y=n.lastY,t.beginPath(),Jt(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()):(t.beginPath(),Jt(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=new i(n.lastX,n.lastY),t=new y(Jt(e),1,Wt,Ut);t.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),t.style=Gt,Number.isFinite(t.pos.x)&&Number.isFinite(t.pos.y)&&Number.isFinite(t.vel.x)&&Number.isFinite(t.vel.y)||(t.vel.x=0,t.vel.y=0),n.physics.addBody(t)}}};ys.append(l("range-slider",{min:5,max:120,step:1,value:qt,onChange:n=>{qt=n}},"Size"),l("range-slider",{min:0,max:1,step:.02,value:Wt,onChange:n=>{Wt=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:Ut,onChange:n=>{Ut=n}},"Coefficient of friction"),l("color-picker",{value:Gt,onChange:n=>{Gt=n}},"Color:"));var xs=Wo;var Qt=45,$t=.2,Kt=1.5,Zt=R,vs=document.createElement("div");function _t(n){let e=n;return n===void 0&&(e=new i(0,0)),P.Polygon([...new Array(8).keys()].map(t=>{let s=2*Math.PI*t/8,o=i.fromAngle(s);return o.mult(Qt),o.add(e),o}))}var Uo={name:"Octagon",description:"",element:vs,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=new i(n.mouseX,n.mouseY);n.mouseDown?(s.x=n.lastX,s.y=n.lastY,t.beginPath(),_t(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()):(t.beginPath(),_t(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=new i(n.lastX,n.lastY),t=new y(_t(e),1,$t,Kt);t.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),t.style=Zt,Number.isFinite(t.pos.x)&&Number.isFinite(t.pos.y)&&Number.isFinite(t.vel.x)&&Number.isFinite(t.vel.y)||(t.vel.x=0,t.vel.y=0),n.physics.addBody(t)}}};vs.append(l("range-slider",{min:5,max:120,step:1,value:Qt,onChange:n=>{Qt=n}},"Size"),l("range-slider",{min:0,max:1,step:.02,value:$t,onChange:n=>{$t=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:Kt,onChange:n=>{Kt=n}},"Coefficient of friction"),l("color-picker",{value:Zt,onChange:n=>{Zt=n}},"Color:"));var ws=Uo;var rt=45,At=.2,en=1.5,tn=R,ks=document.createElement("div");function nn(n){let e=n;n===void 0&&(e=new i(0,0));let t=P.Polygon([...new Array(11).keys()].map(s=>{let o=Math.PI*s/11,a=i.fromAngle(o);return a.mult(rt),a.add(e),a}));return t.points.push(new i(-rt+e.x,e.y)),t}var Go={name:"Half circle",description:"",element:ks,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=new i(n.mouseX,n.mouseY);n.mouseDown?(s.x=n.lastX,s.y=n.lastY,t.beginPath(),nn(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()):(t.beginPath(),nn(s).points.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()),n.lastX!==0&&n.lastY!==0&&(t.beginPath(),t.moveTo(n.mouseX,n.mouseY),t.lineTo(n.lastX,n.lastY),t.stroke())},startInteractionFunc(n){},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=new i(n.lastX,n.lastY),t=new y(nn(e),1,At,en);t.vel=new i(n.lastX-n.mouseX,n.lastY-n.mouseY),t.style=tn,Number.isFinite(t.pos.x)&&Number.isFinite(t.pos.y)&&Number.isFinite(t.vel.x)&&Number.isFinite(t.vel.y)||(t.vel.x=0,t.vel.y=0),n.physics.addBody(t)}}};ks.append(l("range-slider",{min:5,max:120,step:1,value:rt,onChange:n=>{rt=n}},"Size"),l("range-slider",{min:0,max:1,step:.02,value:At,onChange:n=>{At=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:en,onChange:n=>{en=n}},"Coefficient of friction"),l("color-picker",{value:tn,onChange:n=>{tn=n}},"Color:"));var Ms=Go;var sn=.2,on=1.5,an=R,Ss=document.createElement("div"),G=[],Jo={name:"Draw convex shape",description:"",element:Ss,drawFunc(n,e){let t=n.cnv.getContext("2d");t.strokeStyle="black";let s=new i(n.mouseX,n.mouseY);n.mouseDown&&(G.some(o=>o.x===s.x&&o.y===s.y)||G.push(s),G.length>3&&(G=P.Polygon(G).getConvexHull().points)),t.beginPath(),G.forEach((o,a)=>{a===0?t.moveTo(o.x,o.y):t.lineTo(o.x,o.y)}),t.closePath(),t.stroke()},startInteractionFunc(n){},endInteractionFunc(n){if(G.length>3)G=P.Polygon(G).getConvexHull().points;else{G=[];return}if(n.lastX!==0&&n.lastY!==0){let e=new y(P.Polygon(G),1,sn,on),s=[...new Array(100).keys()].map(o=>i.fromAngle(2*Math.PI*o/100)).map(o=>e.shape.getMinMaxInDirection(o).size());if(Math.max(...s)/Math.min(...s)>15){G=[];return}e.style=an,Number.isFinite(e.pos.x)&&Number.isFinite(e.pos.y)&&Number.isFinite(e.vel.x)&&Number.isFinite(e.vel.y)||(e.vel.x=0,e.vel.y=0),n.physics.addBody(e)}G=[]}};Ss.append(l("range-slider",{min:0,max:.35,step:.02,value:sn,onChange:n=>{sn=n}},"Bounciness"),l("range-slider",{min:0,max:2,step:.1,value:on,onChange:n=>{on=n}},"Coefficient of friction"),l("color-picker",{value:an,onChange:n=>{an=n}},"Color:"));var Ps=Jo;var we=[ss,as,os,us,Ps,ls,ds,Ms,ps,bs,xs,ws],V=we[0],Is=document.createElement("div"),rn=l("div",{className:"full-width"}),Cs;function Qo(){return we.indexOf(V)}function Es(n,e){var s;let t=e;(s=V.deactivated)==null||s.call(V,Cs),t[Qo()].bgColor=w.Independence,t[n].bgColor=w.pinkDarker,rn.innerHTML="",rn.appendChild(we[n].element),V=we[n]}var Ve=we.map((n,e)=>l("hover-detector-btn",{onClick:()=>{Es(e,Ve)}},n.name)),$o={name:"Shapes",description:"",element:Is,drawFunc(n,e){var t;(t=V.drawFunc)==null||t.call(V,n,e)},startInteractionFunc(n){var e;(e=V.startInteractionFunc)==null||e.call(V,n)},endInteractionFunc(n){var e;(e=V.endInteractionFunc)==null||e.call(V,n)},init(n){Cs=n,we.forEach(e=>{var t;return(t=e.init)==null?void 0:t.call(e,n)}),Ve.forEach((e,t)=>{t===0&&e.asUpper(),t===Ve.length-1&&e.asLast()})}};Is.append(l("space-height",{height:1}),...Ve,rn);Es(0,Ve);var Bs=$o;var cn=!1,qe=!0,ln=new i(0,0),hn=0,ue=1e4,fe=new C(1,ue);fe.attachObject(new y(P.Circle(1,new i(0,0))));var Ts=document.createElement("div");function Rs(n){let{choosed:e}=n,t=new i(n.lastX,n.lastY);if(n.lastX!==0&&n.lastY!==0&&e instanceof y){let s=i.sub(t,ln);return s.rotate(e.rotation-hn),qe&&(s.x=0,s.y=0),s.add(e.pos),s}return t}function Ko(n,e){return fe.length=n.dist(e),fe.springConstant=ue,fe.objects[0].pos=n,fe.objects[0].shape.points[0]=n,fe.pinHere(e.x,e.y),fe}var Zo={name:"Spring creator",description:"",element:Ts,drawFunc(n,e){let t=n.cnv.getContext("2d");if(t.save(),n.lastX!==0&&n.lastY!==0){t.fillStyle="#00000000",t.strokeStyle="#FFFFFF";let o=Rs(n),a=new i(n.mouseX,n.mouseY),r=Ko(o,a);n.renderer.renderSpring(r,t)}let s=n.physics.getObjectAtCoordinates(n.mouseX,n.mouseY);s instanceof y&&(t.globalAlpha=.6,t.fillStyle="#00000000",t.strokeStyle="#FFFFFF",t.lineWidth=3,n.renderer.renderBody(s,t)),t.restore()},startInteractionFunc(n){n.choosed instanceof y?(ln=n.choosed.pos.copy,hn=n.choosed.rotation):typeof n.choosed!="boolean"&&(ln=new i(n.choosed.x,n.choosed.y),hn=0)},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=n.physics.getObjectAtCoordinates(n.mouseX,n.mouseY),t,s=Rs(n),o=new i(n.mouseX,n.mouseY);n.choosed instanceof y&&qe&&(s=n.choosed.pos.copy),e instanceof y&&qe&&(o=e.pos.copy);let a=C;if(typeof e=="boolean"&&(e={x:n.mouseX,y:n.mouseY,pinPoint:!0}),n.choosed===e||n.choosed===void 0&&e===void 0||n.choosed instanceof Object&&e instanceof Object&&"pinPoint"in n.choosed&&"pinPoint"in e||(n.choosed instanceof Object&&e instanceof Object&&"pinPoint"in n.choosed&&"pos"in e?(t=new a(Math.sqrt((n.choosed.x-e.pos.x)**2+(n.choosed.y-e.pos.y)**2),ue),t.attachObject(e,o),t.pinHere(n.choosed.x,n.choosed.y)):e instanceof Object&&n.choosed instanceof Object&&"pos"in n.choosed&&"pinPoint"in e?(t=new a(Math.sqrt((n.choosed.pos.x-e.x)**2+(n.choosed.pos.y-e.y)**2),ue),t.attachObject(n.choosed,s),t.pinHere(e.x,e.y)):n.choosed instanceof Object&&e instanceof Object&&"pos"in n.choosed&&"pos"in e&&(t=new a(Math.sqrt((n.choosed.pos.x-e.pos.x)**2+(n.choosed.pos.y-e.pos.y)**2),ue),t.attachObject(n.choosed,s),t.attachObject(e,o)),typeof t=="undefined"))return;n.physics.addSpring(t),cn&&t.lockRotation()}}};Ts.append(l("check-box",{checked:cn,onChange:n=>{cn=n}},"Lock rotation"),l("check-box",{checked:qe,onChange:n=>{qe=n}},"Snap to center"),l("range-slider",{min:2e3,max:1e5,value:ue,step:200,onChange:n=>{ue=n}},"Spring stiffness"));var Fs=Zo;var dn=!1,We=!0,mn=new i(0,0),un=0,ke=new B(1);ke.attachObject(new y(P.Circle(1,new i(0,0))));var fn=document.createElement("div");function Os(n){let{choosed:e}=n,t=new i(n.lastX,n.lastY);if(n.lastX!==0&&n.lastY!==0&&e instanceof y){let s=i.sub(t,mn);return s.rotate(e.rotation-un),We&&(s.x=0,s.y=0),s.add(e.pos),s}return t}function _o(n,e){return ke.length=n.dist(e),ke.objects[0].pos=n,ke.objects[0].shape.points[0]=n,ke.pinHere(e.x,e.y),ke}var Ao={name:"Stick creator",description:"",element:fn,drawFunc(n,e){let t=n.cnv.getContext("2d");if(t.save(),n.lastX!==0&&n.lastY!==0){t.fillStyle="#00000000",t.strokeStyle="#FFFFFF";let o=Os(n),a=new i(n.mouseX,n.mouseY),r=_o(o,a);n.renderer.renderStick(r,t)}let s=n.physics.getObjectAtCoordinates(n.mouseX,n.mouseY);s instanceof y&&(t.globalAlpha=.6,t.fillStyle="#00000000",t.strokeStyle="#FFFFFF",t.lineWidth=3,n.renderer.renderBody(s,t)),t.restore()},startInteractionFunc(n){n.choosed instanceof y?(mn=n.choosed.pos.copy,un=n.choosed.rotation):typeof n.choosed!="boolean"&&(mn=new i(n.choosed.x,n.choosed.y),un=0)},endInteractionFunc(n){if(n.lastX!==0&&n.lastY!==0){let e=n.physics.getObjectAtCoordinates(n.mouseX,n.mouseY),t,s=Os(n),o=new i(n.mouseX,n.mouseY);n.choosed instanceof y&&We&&(s=n.choosed.pos.copy),e instanceof y&&We&&(o=e.pos.copy);let a=B;if(typeof e=="boolean"&&(e={x:n.mouseX,y:n.mouseY,pinPoint:!0}),typeof n.choosed=="boolean"||n.choosed===e||n.choosed===void 0&&e===void 0||"pinPoint"in n.choosed&&"pinPoint"in e||("pinPoint"in n.choosed&&"pos"in e?(t=new a(Math.sqrt((n.choosed.x-e.pos.x)**2+(n.choosed.y-e.pos.y)**2)),t.attachObject(e,o),t.pinHere(n.choosed.x,n.choosed.y)):"pinPoint"in e&&"pos"in n.choosed?(t=new a(Math.sqrt((n.choosed.pos.x-e.x)**2+(n.choosed.pos.y-e.y)**2)),t.attachObject(n.choosed,s),t.pinHere(e.x,e.y)):"pos"in n.choosed&&"pos"in e&&(t=new a(Math.sqrt((n.choosed.pos.x-e.pos.x)**2+(n.choosed.pos.y-e.pos.y)**2)),t.attachObject(n.choosed,s),t.attachObject(e,o)),typeof t=="undefined"))return;n.physics.addSpring(t),dn&&t.lockRotation()}},keyGotUpFunc(n){},keyGotDownFunc(n){}};[l("check-box",{checked:dn,onChange:n=>{dn=n}},"Lock rotation"),l("check-box",{checked:We,onChange:n=>{We=n}},"Snap to center")].forEach(fn.appendChild.bind(fn));var Xs=Ao;var Ys=document.createElement("template");Ys.innerHTML=`
  <style>
    .number {
      display: block;
      height: 0.6rem;
